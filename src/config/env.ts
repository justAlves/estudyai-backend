...
export const env = z
  .object({
    ...
    RESEND_API_KEY: z.preprocess((value) => value === "" ? undefined : value, z.string().startsWith("re_").optional()),
    RESEND_FROM_EMAIL: z.string().min(3).default("EstudyAI <onboarding@resend.dev>"),
    RESEND_REPLY_TO: z.preprocess((value) => value === "" ? undefined : value, z.email().optional()),
    ...
    NVIDIA_NIM_API_KEY: z.preprocess((value) => value === "" ? undefined : value, z.string().min(1).optional()),
    NVIDIA_NIM_BASE_URL: z.url().default("https://integrate.api.nvidia.com/v1"),
    NVIDIA_NIM_MODEL: z.string().min(1).default("openai/gpt-oss-20b"),
