...
test("generates one weekdays-only week of free starter tasks", () => {
...
test("generates four weeks for Pro", () => {
  const tasks = initialTasks(["Português", "Matemática"], 120, new Date(2026, 7, 17), 4);
