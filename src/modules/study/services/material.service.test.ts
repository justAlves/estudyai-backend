...
import { activityScore, generationModels, materialRetryDelayMs, normalizeMaterialMarkdown, parseActivities, sourceList } from "./material.service";
...
assert.deepEqual(generationModels("gemini-2.5-flash"), ["gemini-3.6-flash", "gemini-3.5-flash"]);
